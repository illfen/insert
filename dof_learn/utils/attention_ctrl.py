...
class AttentionControlEdit(AttentionStore, abc.ABC):
    ...
    def __init__(self, prompts, num_steps: int,
        ...
        self.cross_replace_alpha = get_time_words_attention_alpha(prompts, num_steps, cross_replace_steps, self.tokenizer).to(device)
...
class AttentionReweight(AttentionControlEdit):
    ...
    def __init__(self, prompts, num_steps: int, cross_replace_steps: float, self_replace_steps: float, equalizer,tokenizer,
        ...
        super(AttentionReweight, self).__init__(prompts, num_steps, cross_replace_steps, self_replace_steps, tokenizer=tokenizer, local_blend=local_blend)
